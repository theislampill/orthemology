...
"Concrete" describes \emph{instantiation} or historical embodiment; "sound" describes a declared \emph{normative/epistemic status}. Neither entails the other: concrete reasoning can be sound or unsound. Soundness here is \textbf{claim-relative} — its proper bearer and dimensions are those of StrictlySoundReasoning, i.e. $\operatorname{StrictlySoundReasoning}_q(e) := \operatorname{ReasoningPathAdequate}_q(e) \wedge \operatorname{TOKEN\_TRUTH\_LINKED}_q(e)$ (Decision 0011), not a free-floating predicate. The Taymiyyan reconstruction (secondary) locates the load-bearing contrast within concretely instantiated reason — \emph{ʿaql ṣarīḥ} (clear reason through a sound disposition and valid sources) versus reason corrupted by inherited premises, whim, conjecture, habit, motive, or imitation — not between "the concrete" and "the sound."
...
\begin{center}
\begin{tabular}{@{}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}p{0.117\linewidth}@{}}
\toprule
\textbf{Order} & \textbf{Stable ID} & \textbf{Node} & \textbf{Scope} & \textbf{Inference / bridge} & \textbf{Claim role} & \textbf{Dependency} & \textbf{Rival exit} \\
\midrule
1 & \texttt{ARG-01} & local evaluability & cross-framework-dialectical & analytic / bounded & orthemological-extension & none & deflationism \\
2 & \texttt{ARG-02} & objective corrigibility & cross-framework-dialectical & explanatory / conditional & orthemological-extension & ARG-01 & humean-regularity \\
3 & \texttt{ARG-03} & bounded representational adaptation & cross-framework-dialectical & computational-analogy / illustrative-only & computational-analogy & ARG-02 & instrumentalism \\
4 & \texttt{ARG-04} & normative proper-function bridge & cross-framework-dialectical & teleological / conditional & cross-source-synthesis & ARG-02, ARG-03 & selected-function-naturalism \\
5 & \texttt{ARG-05} & underived locus & cross-framework-dialectical & transcendental-scope-limited / conditional & orthemological-extension & ARG-01 & aseity-bootstrapping \\
6 & \texttt{ARG-06} & intellectual ground & cross-framework-dialectical & metaphysical-explanatory / conditional & cross-source-synthesis & ARG-05 & impersonal-ground \\
7 & \texttt{ARG-07} & modal status of the ground & cross-framework-dialectical & modal / held & cross-source-synthesis & ARG-05, ARG-06 & modal-primitivism \\
8 & \texttt{ARG-08} & will & cross-framework-dialectical & metaphysical / conditional & cross-source-synthesis & ARG-06 & brute-contingency \\
9 & \texttt{ARG-09} & power & cross-framework-dialectical & metaphysical / conditional & cross-source-synthesis & ARG-08 & impersonal-efficacy \\
10 & \texttt{ARG-10} & Wisdom and fittingness & athari-taymiyyan-operative & creed-internal-teleological / held-pending-source-custody & creed-internal-inference & ARG-04, ARG-06 & euthyphro-fittingness \\
11 & \texttt{ARG-11} & capacity for disclosure & cross-framework-dialectical & metaphysical / conditional & cross-source-synthesis & ARG-06 & capacity-scepticism \\
12 & \texttt{ARG-12} & actual divine Speech & athari-taymiyyan-operative & revelational-school-internal / revelational & creed-internal-inference & ARG-11 & alternative-kalam-articulations \\
13 & \texttt{ARG-13} & Speech bearer classification & athari-taymiyyan-operative & typed-creed-internal-distinction / bounded & creed-internal-inference & ARG-12 & alternative-kalam-articulations \\
14 & \texttt{ARG-14} & Rabb lexical disambiguation candidate & source-bounded-proposed-crosswalk & orthemological-extension / held-pending-individually-verified-lexical-sources & orthemological-extension & none & source-custody-hold \\
\bottomrule
\end{tabular}
\end{center}
...
\item Companion papers: \texttt{orthability-and-the-ground-of-intelligibility.md}, \texttt{orthability-divine-attributes-and-speech-athari.md}; Decisions 0010, 0024, 0025, 0027, 0028.

\end{itemize}

\section{Cross-references (bounded)}
Dynamic orthing / latent learning: \texttt{applications/latent-state-orthing/} (Decision 0024). Meta-noetic memetics / corrective dynamics: \texttt{applications/daee-epistemics/} (Decision 0025). Multi-target noetic orthing: Decision 0027. Represented standards + ecology: Decision 0028.
