...
def main():
    ...
    counts={"deterministic_models":len(models),"deterministic_pairs":0,"bound_long_horizon_cases":0,
            "delayed_length3_witnesses":0,"random_probabilistic_pairs":0,
    ...
    for i,a in enumerate(sigs):
      for j,b in enumerate(sigs):
        ...
        if witness is None and equal_through(a,b,2) and not e3:
            ...
            counts["delayed_length3_witnesses"]+=1
    if witness is None:failures.append({"kind":"no_delayed_witness"})
    ...
    result={"identity":"PMR-007-NIBE-1","checker":"primary deterministic trace enumeration plus random rational weighted systems",
            ...
            "counts":counts,"delayed_witness":witness,"failures":failures[:20],
