...
| 31 | Atharī companion: Allah speaks with speech that is heard; letters; sound | quran (4:87; 4:122; 5:116; 20:11-12; 19:52; 42:11); ibnuthaymin-lumah p.73 | primary/classical | sūrah:āyah | āyāt: PRIMARY-TEXT-VERIFIED (R3 registry `references/quran-loci.yaml`; R2's bare 20:11 was wrong — corrected to 20:11-12); creed-inference locus p.73: VIA-COMPILATION pending edition check | supports the creed-internal claim as an Atharī position | school-flagged: Atharī |
...
| 36 | Manuscript §12.1 / Decision 0015 / related-work note: endpoint performance and endpoint representation do not by themselves determine the learning trajectory or mechanism | sun2025orthogonalized | journal | doi:10.1038/s41586-024-08548-w | WEB-VERIFIED (Crossref record; source-status LAT-1) | supports the bounded abstract claim only | related work, NOT validation; the trajectory-match claim is scoped among the compared models under the reported evaluation |
| 37 | Decision 0015 / related-work note: clone-structured hidden-state mechanism | george2021clone | journal | doi:10.1038/s41467-021-22559-5 | WEB-VERIFIED (Crossref record; source-status LAT-2) | supports the existence/character of the mechanism | CSCG expanded "cognitive" here vs "causal" in the later literature |
| 38 | Decision 0015 / related-work note: latent-sequence framing | raju2024space | journal | doi:10.1126/sciadv.adm8470 | WEB-VERIFIED (Crossref record; source-status LAT-3) | supports the existence of the framing | first author Rajkumar Vasudeva Raju — NOT "Rajeev V. Raju" (Decision 0015 §8) |
...
3. **Rows 36–38 (sequential latent-variable related work):** bibliographic records are officially verified; the underlying experimental procedures were deliberately NOT re-opened or reproduced by the R4 independent review (out of scope by the controlling instruction). The repository claim is a bounded report of what those sources themselves report, governed by Decision 0015 and machine-checked against `references/source-status.yaml` rows LAT-1…LAT-3.
4. No citation was manufactured for a field merely because the related-work table names it; where no specific source is load-bearing (e.g., "ticket state machines" as commodity practice), the text now claims only commodity practice and cites nothing.
