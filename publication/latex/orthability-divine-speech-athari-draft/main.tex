...
\section{From the philosophical companion to the creed: what carries over and what does not}
...
\subsection{Seven Speech bearers}
...
\end{quote}
Sense note (Decision 0010): "orthability" throughout this paper is used in sense \textbf{orthability-O} — the objective conditions of evaluability — never the practice-relative predicate $\operatorname{Orthable}(m; A)$ (sense L) or a created practice's machinery (sense R); the philosophical companion's \href{\detokenize{ARGUMENT-MAP-ORTHABILITY.md}}{\texttt{ARGUMENT-\allowbreak{}MAP-\allowbreak{}ORTHABILITY.\allowbreak{}md}} fixes the senses and the L→O bridge, and nothing in this paper's creed-internal identification changes that typing.


\section{The attribute of Speech: the Atharī articulation}

\subsection{That Allah truly speaks, with speech that is heard}
...
\subsection{Perfection, genus, and particulars: the precise Taymiyyan distinctions}
...
\subsection{The classical proofs that the Qurʾān is not created}
...
\section{Arabic and the "uncreated grammar" metaphor}

\subsection{The three-level account (with the fourth level made explicit)}
...
\subsection{"Uncreated grammar," defined and defused}
...
\subsection{The Qurʾān within the three levels}
...
\section{The reciter's act and the carried Word}
...
\section{Theological precision: the attributes and their distinctions}
...
\section{The contrasting Sunni account, described neutrally}
...
\section{Reason and revelation: the final accounting}
...
\begin{itemize}
\item \emph{al-Qurʾān al-Karīm} (loci per \href{\detokenize{../references/quran-loci.yaml}}{\texttt{references/\allowbreak{}quran-\allowbreak{}loci.\allowbreak{}yaml}}, primary-verified).
