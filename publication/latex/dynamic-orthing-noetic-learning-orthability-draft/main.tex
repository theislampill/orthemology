...
\section{Bearer ontology (the distinctions that must not collapse)}
...
\section{Concrete versus sound reason}
...
\section{Fiṭrah and proper function}
...
\section{Tawātur versus memetic propagation}
...
\section{Mental / external anti-reification}
...
\section{Multi-target noetic orthing}
...
\section{Dynamic orthability (candidate concept)}
...
\subsection{Eight modalities that must not collapse}
...
\subsection{Two numbered scales — do not conflate}
...
\section{Metaphysical argument map}
...
\section{Theological / Atharī route and the created/uncreated distinction}
...
\section{Objections and rival exits}
