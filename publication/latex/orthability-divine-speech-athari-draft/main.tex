...
% source-sha256: 4b64fcb9700de20d9b8896a9ec2419a74771674816f6675ecdcde1614fd78b07
...
\begin{enumerate}
\needspace{3\baselineskip}\item \textbf{Allah's eternal Knowledge of all possibilities} — including every determinate linguistic possibility (§4);

\needspace{3\baselineskip}\item \textbf{Allah's perfection and attribute of Speech} — He has always been One who speaks, never acquiring the capacity (§3);

\needspace{3\baselineskip}\item \textbf{Particular acts of divine Speech occurring when He wills} — His speaking to Mūsā, to Ādam, the sending down of the Qurʾān (§3);

\needspace{3\baselineskip}\item \textbf{Allah's uncreated Speech} — His Speech is His attribute, and His attributes are not created (§3);

\needspace{3\baselineskip}\item \textbf{The Qurʾān as Allah's uncreated Arabic Speech} — a particular Speech He spoke, in Arabic, uncreated (§3, §5);

\needspace{3\baselineskip}\item \textbf{Created human recitation acts} — voices, bodily movements, breath, memorization, and the media: ink, pages, screens (§5);

\needspace{3\baselineskip}\item \textbf{Created historical human Arabic} — speakers, conventions, dialects, scripts, grammarians' descriptions (§4);

\needspace{3\baselineskip}\item \textbf{The eternally known possibility of those created linguistic instantiations} — item 7 as encompassed, before its existence, by item 1 (§4).
...
\begin{enumerate}
\needspace{3\baselineskip}\item \textbf{Uncreated divine Knowledge.} Allah's knowledge of Arabic's complete possibility-space is not acquired from created Arabic and does not wait for Arabic to emerge historically: \emph{Arabic's complete orthability is encompassed by what Allah eternally knows.} (\emph{School-internal, resting on the doctrine of His eternal, uncreated Knowledge.})

\needspace{3\baselineskip}\item \textbf{The eternal attribute and perfection of Speech} (§3.2's first distinction) — inserted explicitly so that Knowledge and Speech are not collapsed (§6).

\needspace{3\baselineskip}\item \textbf{Allah's particular uncreated acts of speaking} — including the Arabic Qurʾān, spoken when He willed, in real ordered words and letters, with a sound befitting Him (§3.2).

\needspace{3\baselineskip}\item \textbf{Created Arabic instantiation.} Arabic as historically instantiated \emph{among creatures} — vocal organs, conventional usages, dialect development, writing systems, grammatical descriptions — is created. Creatures do not create the underlying possibility of intelligible linguistic order out of absolute unintelligibility; they instantiate, discover, conventionalize, and modify particular created forms within a possibility-space already known to Allah.
...
% breakable-row-table: data-rows=7 total-rendered-characters=911 max-row-rendered-characters=208
\par\medskip
\hrule height 0.8pt
\smallskip
% breakable-row: 1/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: An underived ground of intelligibility, not intrinsically incapable of disclosure\par
\noindent\textbf{Basis}: Philosophical (transcendental + conditional; cross-framework dialectical companion, with its stated exits)\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 2/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: That the ground is Allah, who has truly spoken\par
\noindent\textbf{Basis}: Revelational\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 3/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: That His Speech is uncreated; letters and sound befitting Him; heard by whom He wills\par
\noindent\textbf{Basis}: Revelational + school-internal (Atharī articulation, §3)\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 4/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: Genus eternal; particular speeches when He wills; particular ≠ created\par
\noindent\textbf{Basis}: School-internal (Taymiyyan precision, §3.2)\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 5/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: The Qurʾān is His uncreated Arabic Speech; the reciter's voice and the media are created\par
\noindent\textbf{Basis}: Revelational + school-internal (§5)\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 6/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: Arabic's possibility-space eternally known; created Arabic instantiated within it; no reified ``uncreated grammar''\par
\noindent\textbf{Basis}: School-internal synthesis (§4), consistent with — not proven by — the philosophical companion\par
\smallskip
\hrule height 0.4pt
\smallskip
% breakable-row: 7/7
\needspace{5\baselineskip}
\noindent\textbf{Claim}: No engineering result supports any row of this table\par
\noindent\textbf{Basis}: Firewall (absolute)\par
\smallskip
\hrule height 0.8pt
\par\medskip
...
\needspace{4\baselineskip}
\section*{References}
Sources actually cited in this paper. Bibliographic records live in \href{\detokenize{../references/orthemology.bib}}{\texttt{references/\allowbreak{}orthemology.\allowbreak{}bib}}. \textbf{Per-claim evidence-access statuses are NOT restated here} — they live in \href{\detokenize{../references/source-status.yaml}}{\texttt{references/\allowbreak{}source-\allowbreak{}status.\allowbreak{}yaml}} rows \texttt{ATH-1}…\texttt{ATH-7} and the sourcing surfaces (start at \href{\detokenize{../docs/sourcing/CURRENT-SOURCING-LEDGER.md}}{\texttt{docs/\allowbreak{}sourcing/\allowbreak{}CURRENT-\allowbreak{}SOURCING-\allowbreak{}LEDGER.\allowbreak{}md}}); a work's presence in this list asserts bibliographic identity only, never a wording-access claim. Classical works are cited with the school-internal loci given inline; several page loci are edition-dependent (research residual RR-1).


\begin{itemize}
\needspace{3\baselineskip}\item \emph{al-Qurʾān al-Karīm} (loci per \href{\detokenize{../references/quran-loci.yaml}}{\texttt{references/\allowbreak{}quran-\allowbreak{}loci.\allowbreak{}yaml}}, primary-verified).

\needspace{3\baselineskip}\item Muslim ibn al-Ḥajjāj. \emph{Ṣaḥīḥ Muslim} (ḥadīth 2708).

\needspace{3\baselineskip}\item al-Bukhārī, Muḥammad ibn Ismāʿīl. \emph{Khalq Afʿāl al-ʿIbād}.

\needspace{3\baselineskip}\item Ibn Taymiyyah, Aḥmad. \emph{Majmūʿ al-Fatāwā} (vol. 12; the words/voice formula is carried at registry row \texttt{ATH-3}'s recorded strength).

\needspace{3\baselineskip}\item Ibn ʿUthaymīn, Muḥammad ibn Ṣāliḥ. \emph{Sharḥ Lumʿat al-Iʿtiqād}.

\needspace{3\baselineskip}\item al-Ājurrī, Muḥammad ibn al-Ḥusayn. \emph{ash-Sharīʿah}.

\needspace{3\baselineskip}\item Ḥanbal ibn Isḥāq. \emph{Dhikr Miḥnat al-Imām Aḥmad ibn Ḥanbal}.

\needspace{3\baselineskip}\item ad-Dārimī, ʿUthmān ibn Saʿīd. \emph{ar-Radd ʿalā al-Jahmiyyah}.

\needspace{3\baselineskip}\item Permanent Committee for Scholarly Research and Iftāʾ. \emph{Fatāwā al-Lajnah ad-Dāʾimah} (vol. 3).

\needspace{3\baselineskip}\item Ibn Abī Ḥātim ar-Rāzī. \emph{Ādāb ash-Shāfiʿī wa-Manāqibuh}.

\needspace{3\baselineskip}\item Hoover, Jon (2004). ``Perpetual Creativity in the Perfection of God: Ibn Taymiyya's Hadith Commentary on God's Creation of this World.'' \emph{Journal of Islamic Studies} 15(3).

\needspace{3\baselineskip}\item Cooperson, Michael (2000). \emph{Classical Arabic Biography: The Heirs of the Prophets in the Age of al-Maʾmūn}. Cambridge University Press.

\needspace{3\baselineskip}\item Melchert, Christopher (2006). \emph{Ahmad ibn Hanbal}. Oneworld.
