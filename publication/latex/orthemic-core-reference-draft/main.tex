...
% source-sha256: 53d800477d0fbe328a6a460b11f92e704b124bd25518fa00acc2093297954d70
...
% breakable-row-table: data-rows=23 total-rendered-characters=5184 max-row-rendered-characters=1651
\par\medskip
\hrule height 0.8pt
\smallskip
% breakable-row: 1/23
...
\end{itemize}
For this display only, write $G_\alpha:=\mathcal{G}_\alpha$ and $G_\beta:=\mathcal{G}_\beta$.
