...
* standalone parser/elaborator/kernel run under Lean 4.32.2: PASS;
* axiom report: captured in the adjacent intake receipt;
* repository project build/adoption: NOT RUN / NONE.
...
structure CommonInterventionCertificate
    ...
    (AbstractSemantics : Type uS)
    (ComparableOutput : Type uO) where
  spec : CommonInterventionSpec.{uA, uI, uS, uO, uR}
...
#print axioms BoundedChallengerB.factorsThroughProfileQuotient_iff_fiberConstant
#print axioms BoundedChallengerB.profileQuotient_decoder_unique
#print axioms BoundedChallengerB.fullProfileFactor_implies_fiberConstant
