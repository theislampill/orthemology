...
\section{Type/token resolution (2A)}
...
\section{Episode signature (2B)}

\subsection{Candidate formulations compared}
...
\subsection{Recommended signature (formal)}
...
\section{Metaortheme semantics (2C)}
...
\subsection{Minimum-specificity test against the five worked examples}
...
\subsection{Plurality, conflict, precedence, provenance, revision, safeguards}
...
\section{Pathway adequacy (2D)}

\subsection{Separate verdicts}
...
\subsection{Result × pathway matrix}
...
\subsection{Epistemic constraint and nearest neighbors}
...
\section{Mechanical and distributed orthing (2E)}

\subsection{Mechanical executors}
...
\subsection{Distributed episodes: graph and composition}
...
\subsection{Multi-actor episodes over one occurrence lineage (derived)}
...
\subsection{Semantic depth as an orthogonal axis}
